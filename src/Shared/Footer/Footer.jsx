  ...
  return (
    <footer className="footer p-10 bg-base-200  text-base-content">
      <div className="justify-items-center">
        ...
        <p>Copyright © 2023 - All right reserved by Chef's Tasty Treats</p>
      </div>
      ...
      <div>
        ...
        <p className="text-orange-500">
          <a className="link link-hover ">
            {" "}
            <FontAwesomeIcon className="mb-3 mr-4" icon={faPhone} beatFade size="2xl" /> +44 (0) 20 9994
            7740{" "}
          </a>{" "}
        </p>
        ...
        <p className="text-orange-500">
          <a className="link link-hover">
            {" "}
            <FontAwesomeIcon className="mb-3 mr-4" icon={faEnvelope} beatFade size="2xl" />
            Tastytreats@gmail.com
          </a>
        </p>
        <p className="text-orange-500">
          {" "}
          <FontAwesomeIcon className="mb-3 mr-4" icon={faMapMarkerAlt} beatFade size="2xl" />
          Blackwell Street,Dry Creek,Newyork
        </p>
        <div className="w-full h-0.5 bg-gray-300 my-4"></div>
        <div>
          <FontAwesomeIcon icon={faFacebook} beat size="2xl" />
          <FontAwesomeIcon className="mx-4" icon={faTwitter} beat size="2xl"/>
